    ...
    <div className="experience-container">
      ...
      <div className="experience-item">
        <div className="experience-role">
          ...
          Chick-Fil-A Corporate | Software Engineer Intern
          <br/>
          Jan 2023 - May 2023
        </div>
        <div className="experience-description">
      ...
      <div className="experience-item">
        <div className="experience-role">
          ...
          NJ Transit | Software Engineer Intern
          <br/>
          June 2022 - Aug 2022
        </div>
        <div className="experience-description">
          Reduced data processing time from 3 minutes to 30 seconds by implementing an automated system in Python</div>
      </div>

      {/* Wi-Drive */}
      <div className="experience-item">
        <div className="experience-role">
          <img src="/wd.png" alt="Wi-Drive Logo" className="experience-logo" width={60} height={60} style={{marginRight: '5%'}}/>
